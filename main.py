...
class MainApp(QMainWindow):
    def __init__(self):
        ...
        self.cols_sub_table = ["SI NO","E-mail","Match","Subject","Date Sent"]
    ...
    def escalationWarning(self,warning):
        self.showDialog('Warning Error',QMessageBox.Critical,f'''{warning}''')

    @pyqtSlot(tuple)
    def escalationProgress(self,processed):
        self.ui.escalation_label_1.setText(f"Processing     : {processed[0]} ")
        self.ui.escalation_label_2.setText(f"Processed      : [ {processed[1]} of {len(self.tickets)} ]")
        self.ui.escalation_label_3.setText(f"Time Elapsed   : {self.convertSecsToHHMMSS(self.time)}")
    ...
    def mboxEmlDirPath(self):
        ...
        self.EmlMBoxPath = QFileDialog.getExistingDirectory(self,"Choose MBox/Eml folder",prevMBoxPath)
...
"color: rgb(240, 240, 240);")
        ...
        for i,colItem in enumerate(colItems):
            ...
            if mode == "allmails" and isAttachment and i == 2:
                ...
                if i == 1:
                    ...
                    self.label.setText(linkTemplate.format(colItem[1], colItem[0]))
    ...
    def startSearch(self):
        ...
        self.ConfigureTable(self.ui.tableWidget_3,self.cols_sub_table,colCount=5,matchCol=True)
    ...
    def updateSubjectNotFoundTable(self,ticket):
        ...
        self.updateTable(self.ui.tableWidget_3,ticket,searching=True,subject=True)
    ...
    def loadPreviousResults(self):
        ...
        self.ConfigureTable(self.ui.tableWidget_5,self.cols_sub_table,colCount=5,matchCol=True)
