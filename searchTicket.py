...
from parse import error,missing_sub_logger,missing_ticket
                                                ...
                                                # check if subject is empty
                                                    try:
                                                        ...
                                                        if sub_obj==True:
                                                            ...
                                                            for tick in sub_obj:
                                                                r = search_query(_dict['session'],tick)
...
def search_query(s,search):
    ...
    try:
        ...
        return r
                ...
                error.exception(f'Request-HTTPError: {errh} {search}')
                return 'error-http'
    except requests.exceptions.ConnectionError as errc:
                error.exception(f'Request-ConnectionError: {errc} {search}')
                return 'error-connection'
    except requests.exceptions.Timeout as errt:
                error.exception(f'Request-Timeout: {errt} {search}')
                return 'error-timeout'
    except requests.exceptions.RequestException as err:
                error.exception(f'Request-Exception: {err} {search}')
